  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/3 right-1/3 w-[400px] h-[400px] rounded-full bg-[var(--color-accent)]/5 blur-[100px]" />
      </div>
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[var(--color-secondary)] mt-1">Start making data-driven content decisions</p>
        </div>
        <SignupForm />
